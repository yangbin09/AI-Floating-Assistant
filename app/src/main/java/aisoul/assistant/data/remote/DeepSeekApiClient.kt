package com.aisoul.assistant.data.remote
...
import com.aisoul.assistant.data.remote.model.DeepSeekResponse
...
class DeepSeekApiClient(
    ...
    private fun parseDeepSeekResponse(json: String): DeepSeekResponse {
        ...
        val choices = mutableListOf<com.aisoul.assistant.data.remote.model.DeepSeekChoice>()
        ...
        for (i in 0 until choicesArray.length()) {
            ...
            choices.add(
                com.aisoul.assistant.data.remote.model.DeepSeekChoice(
                    index = choiceObj.getInt("index"),
                    message = com.aisoul.assistant.data.remote.model.DeepSeekMessage(
        ...
        val usage = if (jsonObject.has("usage") && !jsonObject.isNull("usage")) {
            ...
            com.aisoul.assistant.data.remote.model.DeepSeekUsage(
        ...
        return com.aisoul.assistant.data.remote.model.DeepSeekResponse(
